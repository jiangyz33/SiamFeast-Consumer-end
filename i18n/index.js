...
const messages = {
	...
	en: {
		...
		productDetail: {
			...
			noticeImage: 'Actual product may vary from images',
		...
		share: {
			...
			shopDesc: 'Found a great shop, come check it out!',
		...
		checkout: {
			...
			excludedFromDiscount: 'This order is not eligible for discounts',
			...
			couponNotApplicable: '(Not applicable)',
			couponNotStackable: '(Conflicts with active campaign)',
			itemNotFound: 'Some items are unavailable or removed',
			pleaseSelect: 'Select',
		...
		memberCode: {
			...
			hint: 'Show this code to cashier for member identification',
			secondsUnit: ' s',
			refresh: 'Refresh Code',
			refreshFailed: 'Refresh failed, please try again',
			dynamicHint: 'Dynamic code valid for 60 seconds, refresh when expired'
		},
		order: {
			title: 'My Orders',
			all: 'All',
		...
		invite: {
			...
			subtitle: 'Join SiamFeast and enjoy great food deals with your friend',
			inviterCode: "Friend's invite code",
			rewardDesc: 'Register now — both you and your friend earn coin rewards',
		...
		coinConfirm: {
			...
			modalContent: 'The cashier at [{store}] requests to use {coins} coins (deduct ฿{amount}). Approve?',
			...
			deniedText: 'Denied',
			noPending: 'No pending coin usage request',
			statusConflict: 'This request was already handled or expired. Refreshed.',
		...
		mine: {
			...
			deleteAccountWarning: 'Your personal data will be erased, all coins and points will be voided, and this cannot be undone. Order records will be retained anonymously as required by law.',
			...
			deleteAccountBlockedOrders: 'You have unfinished orders. Please complete or cancel them first.',
			...
			footprint: 'Footprint',
				...
				shareGuideContent: '1. Tap "Share Link" to copy your personal invite link\n2. Paste it in a chat (WeChat / LINE / WhatsApp) and send to friends\n3. Friends open the link in a browser — it will take them to the signup page with your invite code pre-filled\n4. Once they sign up and place their first order, both of you earn rewards',
			...
			taskRecords: 'Tasks',
				...
				rewardCommission: 'Order Commission',
				coinUnit: 'coins',
				pointUnit: 'pts',
			invoice: 'Invoice',
		...
		login: {
			...
			emailLoginHint: 'Out of SMS quota? Enter your phone number and email to receive code via email',
			emailInvalid: 'Invalid email format',
			useEmailLogin: 'Use email verification code',
			useSmsLogin: 'Use SMS verification code',
			smsQuotaExceededHint: 'SMS quota exhausted. Switch to email verification?',
			smsQuotaExceededAutoSwitch: 'SMS quota exhausted. Switched to email login automatically. Please enter your email to receive the code',
			passwordLogin: 'Password Login',
			...
			smsNotSupported: 'SMS login is not supported in this environment',
			emailPlaceholder: 'Enter your email',
			emailCodeSent: 'Code sent to email',
			emailSendFailed: 'Failed to send code',
			codeSentToEmail: 'Code sent to email: {email}',
			quotaWarning: '⚠️ {warning}',
			quotaExhausted: 'SMS quota exhausted, please bind an email and retry',
			bindEmailHint: 'Your SMS quota is exhausted. Please bind an email in Settings and retry',
			...
			inviteCodeHint: 'Enter an invite code — both you and the referrer earn rewards after signup',
			inviteCodeFilled: '✓ Added',
			inviteCodePromptTitle: 'Have an invite code?',
			inviteCodePromptDesc: 'Enter an invite code to earn rewards for both you and the referrer. Skip if you don\'t have one.',
			inviteCodeSkip: 'Skip',
			inviteCodeSubmit: 'Bind',
			inviteCodeRequired: 'Please enter invite code',
			inviteCodeBound: 'Invite code bound successfully',
		...
		settings: {
			...
			avatarTooLarge: 'Avatar image must be 5MB or less',
		...
		coupons: {
			...
			tabAll: 'All',
			expireEnd: 'expires',
			offlineRedeem: 'Redeem In-Store',
			offlineRedeemTitle: 'Redeem In-Store',
			offlineRedeemHint: 'Show this code to the cashier to redeem',
			redeemNoScreenshot: 'Show in person, screenshots may not work',
			couponIdLabel: 'Coupon ID',
			itemVoucher: 'Item Voucher'
		},
		address: {
			title: 'My Address',
			add: 'Add Address',
		...
		discount: {
			...
			coinInsufficient: 'Insufficient coins',
			...
			codeNotSent: 'Please request a verification code first',
			codeTooManyAttempts: 'Too many attempts, please resend',
			accountDisabled: 'Account disabled, please contact support',
			smsNotConfigured: 'SMS service is temporarily unavailable',
			smsSendFailed: 'Failed to send SMS, please try again later',
			smsQuotaExhausted: 'SMS quota exhausted for this year',
			smsQuotaNoEmail: 'SMS quota exhausted, please bind an email and try again',
			orderingDisabled: 'Online ordering is not available at this store, please order in-store',
			couponStoreNotMatch: 'This coupon does not belong to this store, please use it at the corresponding store',
			openingCouponNotStoreBound: 'Opening coupon configuration error, cannot claim for now',
			smsLoginFailed: 'Login failed, please try again',
			registerFailed: 'Registration failed, please try again',
			phoneAlreadyRegistered: 'This phone number is already registered, please log in directly',
		...
		campaign: {
			...
			datePattern: 'Applicable dates',
			doubleDay: 'Same month-day (7/7, 8/8…)',
			crossYear: 'spans year-end',
		...
		exchange: {
			...
			successSimple: 'Exchange successful',
		...
		tasks: {
			...
			inviteProgressRules: 'Each tier counts separately: once a tier is completed, the next one starts from 0. Progress resets annually with the points reset',
	...
	th: {
		...
		index: {
			...
			pointsMallDesc: 'แลกคะแนนและเหรียญ',
			coinMall: 'ร้านแลกของ',
			vending: 'ตู้ขายอัตโนมัติ',
			vendingDesc: 'สแกนแลกสินค้า',
		},
		vending: {
		...
		storeSelect: {
			...
			locationDenied: 'ไม่ได้รับอนุญาตตำแหน่ง',
		...
		productDetail: {
			...
			purchaseNotice: 'ข้อควรทราบ',
			noticeImage: 'สินค้าจริงอาจแตกต่างจากในภาพ',
...
coinDeductUnavailable: 'ไม่สามารถใช้เหรียญเพื่อหักได้ในขณะนี้',
			...
			excludedFromDiscount: 'คำสั่งซื้อนี้ไม่ร่วมส่วนลด',
			...
			couponNotApplicable: '(ใช้ไม่ได้)',
			couponNotStackable: '(ใช้ซ้อนกับโปรไม่ได้)',
			itemNotFound: 'บางรายการไม่มีหรือถูกลบแล้ว',
			pleaseSelect: 'เลือก',
		...
		memberCode: {
			...
			hint: 'แสดงรหัสนี้ให้พนักงานเพื่อระบุตัวตนสมาชิก',
			secondsUnit: ' วิ',
			refresh: 'รีเฟรชรหัส',
			refreshFailed: 'รีเฟรชไม่สำเร็จ กรุณาลองอีกครั้ง',
			dynamicHint: 'รหัสไดนามิกใช้ได้ 60 วินาที หมดอายุแล้วกรุณารีเฟรช'
		},
		order: {
			...
			groupBuy: 'รวม order',
			exchangeOrders: 'คำสั่งแลก',
			exchangeOrder: 'แลก',
			pointExchange: 'แลกคะแนน',
			coinExchange: 'แลกเหรียญ',
			viewCode: 'ดูรหัส',
		...
		orderDetail: {
			...
			campaignDiscount: 'ส่วนลดโปรโมชัน',
			rounding: 'ปัดเศษ',
		...
		invite: {
			...
			inviterCode: 'รหัสเชิญจากเพื่อน',
			rewardDesc: 'สมัครสำเร็จ คุณและเพื่อนจะได้รับรางวัลเหรียญทั้งคู่',
		...
		coinConfirm: {
			...
			modalContent: 'พนักงานแคชเชียร์ที่ [{store}] ขอใช้ {coins} เหรียญ (หัก ฿{amount}) ยืนยันหรือไม่?',
			...
			deniedText: 'ปฏิเสธแล้ว',
			noPending: 'ไม่มีคำขอใช้เหรียญที่รอยืนยัน',
			statusConflict: 'คำขอนี้ดำเนินการแล้วหรือหมดอายุ ระบบรีเฟรชให้แล้ว',
		...
		mine: {
			...
			deleteAccountWarning: 'ข้อมูลส่วนบุคคลของคุณจะถูกลบ เหรียญและคะแนนทั้งหมดจะสิ้นสุด และไม่สามารถกู้คืนได้ บันทึกคำสั่งซื้อจะเก็บโดยไม่ระบุตัวตนตามกฎหมาย',
			...
			deleteAccountBlockedOrders: 'คุณมีคำสั่งซื้อที่ยังไม่เสร็จสิ้น กรุณาดำเนินการให้เสร็จก่อน',
			...
			footprint: 'ประวัติ',
				...
				shareGuideContent: '1. แตะ "แชร์ลิงก์" เพื่อคัดลอกลิงก์เชิญส่วนตัว\n2. วางในแชท (WeChat / LINE / WhatsApp) แล้วส่งให้เพื่อน\n3. เพื่อนเปิดลิงก์ในเบราว์เซอร์ จะเด้งไปหน้าสมัครพร้อมกรอกรหัสเชิญของคุณอัตโนมัติ\n4. เมื่อเพื่อนสมัครสำเร็จและสั่งซื้อครั้งแรก ทั้งคุณและเพื่อนจะได้รับรางวัล',
			...
			pendingActivation: 'รอเปิดใช้',
			taskRecords: 'ภารกิจ',
				pointsEarned: 'คะแนนที่ได้',
				invitedUsers: 'ผู้ใช้ที่เชิญ',
				rewardRecords: 'รางวัล',
				noReferees: 'ยังไม่มีการเชิญ',
				anonymousUser: 'ผู้ใช้ไม่ระบุตัวตน',
				directReferral: 'โดยตรง',
				indirectReferral: 'ทางอ้อม',
				orderNo: 'เลขคำสั่ง',
				noRewards: 'ยังไม่มีรางวัล',
				rewardSignUp: 'รางวัลสมัคร',
				rewardFirstOrder: 'รางวัญออเดอร์แรก',
				rewardCommission: 'ค่าคอมมิชชั่น',
				coinUnit: 'เหรียญ',
				pointUnit: 'คะแนน',
			invoice: 'ใบเสร็จ',
		...
		login: {
			...
			emailLoginHint: 'ใช้ SMS ครดแล้ว? กรอกเบอร์โทรและอีเมลเพื่อรับรหัสผ่านอีเมล',
			emailInvalid: 'รูปแบบอีเมลไม่ถูกต้อง',
			useEmailLogin: 'ใช้รหัสยืนยันอีเมล',
			useSmsLogin: 'ใช้รหัสยืนยัน SMS',
			smsQuotaExceededHint: 'ใช้ SMS ครดแล้ว ต้องการสลับไปใช้รหัสยืนยันอีเมลไหม?',
			smsQuotaExceededAutoSwitch: 'โควต้า SMS หมดแล้ว ระบบสลับไปอีเมลอัตโนมัติ กรุณากรอกอีเมลเพื่อรับรหัสยืนยัน',
			passwordLogin: 'เข้าสู่ระบบด้วยรหัสผ่าน',
			...
			smsNotSupported: 'สภาพแวดล้อมนี้ไม่รองรับการเข้าสู่ระบบด้วย SMS',
			...
			quotaWarning: '⚠️ {warning}',
			quotaExhausted: 'โควต้า SMS หมดแล้ว กรุณาผูกอีเมลแล้วลองอีกครั้ง',
			bindEmailHint: 'โควต้า SMS ของคุณหมดแล้ว กรุณาผูกอีเมลในหน้าตั้งค่าแล้วลองอีกครั้ง',
			passwordPlaceholder: 'รหัสผ่าน',
			passwordHint: 'อย่างน้อย 6 ตัวอักษร',
			passwordMismatch: 'รหัสผ่านที่กรอกไม่ตรงกัน',
			...
			inviteCodeHint: 'กรอกรหัสเชิญ — คุณและผู้เชิญจะได้รับรางวัลหลังสมัครสำเร็จ',
			inviteCodeFilled: '✓ กรอกแล้ว',
			inviteCodePromptTitle: 'มีรหัสเชิญไหม?',
			inviteCodePromptDesc: 'กรอกรหัสเชิญเพื่อรับรางวัลทั้งคุณและผู้เชิญ ถ้าไม่มีให้ข้ามได้',
			inviteCodeSkip: 'ข้าม',
			inviteCodeSubmit: 'ผูก',
			inviteCodeRequired: 'กรุณากรอกรหัสเชิญ',
			inviteCodeBound: 'ผูกรหัสเชิญสำเร็จ',
		...
		coupons: {
			...
			tabAll: 'ทั้งหมด',
			expireEnd: 'หมดอายุ',
			offlineRedeem: 'รับที่ร้าน',
			offlineRedeemTitle: 'รับที่ร้าน',
			offlineRedeemHint: 'แสดงคิวอาร์โค้ดนี้ที่เคาน์เตอร์เพื่อรับสิทธิ์',
			redeemNoScreenshot: 'กรุณาแสดงที่หน้าร้าน ภาพหน้าจออาชใช้ไม่ได้',
			couponIdLabel: 'รหัสคูปอง',
			itemVoucher: 'คูปองอาหาร·ใช้ที่หน้าร้าน'
		},
		address: {
			title: 'ที่อยู่ของฉัน',
			add: 'เพิ่มที่อยู่',
		...
		discount: {
			...
			codeNotSent: 'กรุณาขอรหัสยืนยันก่อน',
			codeTooManyAttempts: 'พยายามหลายครั้งเกินไป กรุณาขอรหัสใหม่',
			...
			smsQuotaExhausted: 'โควต้า SMS หมดแล้วสำหรับปีนี้',
			smsQuotaNoEmail: 'โควต้า SMS หมดแล้ว กรุณาผูกอีเมลแล้วลองใหม่',
			orderingDisabled: 'ร้านนี้ยังไม่เปิดสั่งออนไลน์ กรุณาสั่งที่ร้าน',
			couponStoreNotMatch: 'คูปองนี้ไม่ได้ใช้กับร้านนี้ กรุณาใช้ที่ร้านที่กำหนด',
			openingCouponNotStoreBound: 'การตั้งค่าคูปองเปิดร้านผิดพลาด ยังรับไม่ได้ชั่วคราว',
			smsLoginFailed: 'เข้าสู่ระบบไม่สำเร็จ กรุณาลองอีกครั้ง',
			registerFailed: 'ลงทะเบียนไม่สำเร็จ กรุณาลองอีกครั้ง',
			phoneAlreadyRegistered: 'เบอร์นี้ลงทะเบียนแล้ว กรุณาเข้าสู่ระบบโดยตรง',
		...
		tasks: {
			...
			inviteProgressRules: 'ความคืบหน้าของแต่ละขั้นนับแยกกัน หลังจบขั้นหนึ่งจะเริ่มนับขั้นถัดไปใหม่ และจะรีเซ็ตพร้อมแต้มทุกปี',
			inviteLocked: 'เชิญครบตามขั้นก่อนหน้าเพื่อเริ่มนับ',
			locked: 'ยังไม่ปลดล็อก',
