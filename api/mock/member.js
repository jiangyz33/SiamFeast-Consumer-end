...
const mockMallOrders = [
	{ id: 1, product_name: '满30减10优惠券', product_id: 1, points_cost: 500, status: 'COMPLETED', created_at: '2024-12-01T10:00:00Z' },
	{ id: 2, product_name: '品牌定制马克杯', product_id: 3, points_cost: 1500, status: 'PROCESSING', created_at: '2024-12-10T14:30:00Z' }
]
	...
	return new Promise((resolve) => {
		setTimeout(() => {
			...
			if (order.status === 'COMPLETED') {
				return resolve({ code: -1, message: '已完成的订单不可取消' })
			}
